class Game
    ...
    def column_full?(current_player_input)
        column_number = current_player_input.ord - 'A'.ord #takes A-G and subtracts ASCII value (65) from the player input, so 65-65 = 0 which is A, 65-64 = 1 which is B, etc.
